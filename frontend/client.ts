 ...
 */
import type { auth as auth_auth } from "~backend/auth/auth_handler";
 ...
 */
import {
    createAddress as api_auth_addresses_createAddress,
    deleteAddress as api_auth_addresses_deleteAddress,
    updateAddress as api_auth_addresses_updateAddress
} from "~backend/auth/addresses";
import { login as api_auth_login_login } from "~backend/auth/login";
import { getProfile as api_auth_profile_getProfile } from "~backend/auth/profile";
...
export namespace auth {
    ...
    export class ServiceClient {
         ...
         */
        public async createAddress(params: RequestType<typeof api_auth_addresses_createAddress>): Promise<ResponseType<typeof api_auth_addresses_createAddress>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/addresses`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_addresses_createAddress>
        }

        /**
         * Deletes an address for the current user.
         */
        public async deleteAddress(params: { id: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/auth/addresses/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }

        /**
         * Retrieves the current user's profile and addresses.
         */
        public async getProfile(): Promise<ResponseType<typeof api_auth_profile_getProfile>> {
            // Now make the actual call to the API
         ...
         */
        public async updateAddress(params: RequestType<typeof api_auth_addresses_updateAddress>): Promise<ResponseType<typeof api_auth_addresses_updateAddress>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/addresses/${encodeURIComponent(params.id)}`, {method: "PUT", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_addresses_updateAddress>
        }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getOrder as api_orders_get_getOrder } from "~backend/orders/get";
import { listOrders as api_orders_list_listOrders } from "~backend/orders/list";
...
export namespace orders {
    ...
    export class ServiceClient {
         ...
         */
        public async getOrder(params: { id: number }): Promise<ResponseType<typeof api_orders_get_getOrder>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/orders/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_orders_get_getOrder>
        }

        /**
         * Retrieves the current user's order history.
         */
        public async listOrders(params: RequestType<typeof api_orders_list_listOrders>): Promise<ResponseType<typeof api_orders_list_listOrders>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_orders_list_listOrders>
        }
    }
}
