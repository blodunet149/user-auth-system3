...
export const createAddress = api<CreateAddressRequest, Address>(
  ...
  async (req) => {
    try {
      ...
      throw APIError.internal("Failed to create address", error);
    }
  }
);
...
export const updateAddress = api<{ id: number } & UpdateAddressRequest, Address>(
  ...
  async (req) => {
    try {
      ...
      throw APIError.internal("Failed to update address", error);
    }
  }
);
...
export const deleteAddress = api<{ id: number }, void>(
  ...
  async (req) => {
    try {
      ...
      throw APIError.internal("Failed to delete address", error);
    }
  }
);
